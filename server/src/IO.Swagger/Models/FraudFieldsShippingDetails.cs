...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FraudFieldsShippingDetails : Dictionary<String, Object>, IEquatable<FraudFieldsShippingDetails>
    { 
        /// <summary>
        /// Gets or Sets MethodDetails
        /// </summary>
        [DataMember(Name="methodDetails")]
        public string MethodDetails { get; set; }

        /// <summary>
        /// Gets or Sets MethodSpeed
        /// </summary>
        [DataMember(Name="methodSpeed")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FraudFieldsShippingDetails {\n");
            sb.Append("  MethodDetails: ").Append(MethodDetails).Append("\n");
            sb.Append("  MethodSpeed: ").Append(MethodSpeed).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FraudFieldsShippingDetails)obj);
        }
        ...
        public static bool operator ==(FraudFieldsShippingDetails left, FraudFieldsShippingDetails right)
        {

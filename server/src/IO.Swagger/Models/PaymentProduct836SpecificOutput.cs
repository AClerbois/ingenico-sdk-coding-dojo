...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProduct836SpecificOutput : Dictionary<String, Object>, IEquatable<PaymentProduct836SpecificOutput>
    { 
        /// <summary>
        /// Gets or Sets SecurityIndicator
        /// </summary>
        [DataMember(Name="securityIndicator")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentProduct836SpecificOutput {\n");
            sb.Append("  SecurityIndicator: ").Append(SecurityIndicator).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PaymentProduct836SpecificOutput)obj);
        }

        /// <summary>
        /// Returns true if PaymentProduct836SpecificOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProduct836SpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProduct836SpecificOutput other)
        {
            ...
            return 
                (
                    SecurityIndicator == other.SecurityIndicator ||
                    SecurityIndicator != null &&
                    SecurityIndicator.Equals(other.SecurityIndicator)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + SecurityIndicator.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(PaymentProduct836SpecificOutput left, PaymentProduct836SpecificOutput right)
        {

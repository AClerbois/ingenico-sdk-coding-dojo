...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FraudResults : Dictionary<String, Object>, IEquatable<FraudResults>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Results from the fraud prevention check. Possible values are:  * accepted - Based on the checks performed the transaction can be accepted  * challenged - Based on the checks performed the transaction should be manually reviewed  * denied - Based on the checks performed the transaction should be rejected  * no-advice - No fraud check was requested/performed * error - The fraud check resulted in an error and the fraud check was thus not performed</value>
        [DataMember(Name="fraudServiceResult")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FraudResults)obj);
        }

        /// <summary>
        /// Returns true if FraudResults instances are equal
        /// </summary>
        /// <param name="other">Instance of FraudResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FraudResults other)
        {
            ...
            return 
                (
                    FraudServiceResult == other.FraudServiceResult ||
                    FraudServiceResult != null &&
                    FraudServiceResult.Equals(other.FraudServiceResult)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (FraudServiceResult != null)
                    hashCode = hashCode * 59 + FraudServiceResult.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(FraudResults left, FraudResults right)
        {

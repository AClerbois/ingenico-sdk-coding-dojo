...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RefundEInvoiceMethodSpecificOutput : RefundMethodSpecificOutput, IEquatable<RefundEInvoiceMethodSpecificOutput>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundEInvoiceMethodSpecificOutput {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RefundEInvoiceMethodSpecificOutput)obj);
        }

        /// <summary>
        /// Returns true if RefundEInvoiceMethodSpecificOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of RefundEInvoiceMethodSpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundEInvoiceMethodSpecificOutput other)
        {
        ...
        public static bool operator ==(RefundEInvoiceMethodSpecificOutput left, RefundEInvoiceMethodSpecificOutput right)
        {

...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InvoicePaymentMethodSpecificOutput : AbstractPaymentMethodSpecificOutput, IEquatable<InvoicePaymentMethodSpecificOutput>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvoicePaymentMethodSpecificOutput {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InvoicePaymentMethodSpecificOutput)obj);
        }

        /// <summary>
        /// Returns true if InvoicePaymentMethodSpecificOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoicePaymentMethodSpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoicePaymentMethodSpecificOutput other)
        {
        ...
        public static bool operator ==(InvoicePaymentMethodSpecificOutput left, InvoicePaymentMethodSpecificOutput right)
        {

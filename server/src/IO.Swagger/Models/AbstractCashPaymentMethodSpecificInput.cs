...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AbstractCashPaymentMethodSpecificInput : AbstractPaymentMethodSpecificInput, IEquatable<AbstractCashPaymentMethodSpecificInput>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AbstractCashPaymentMethodSpecificInput {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AbstractCashPaymentMethodSpecificInput)obj);
        }

        /// <summary>
        /// Returns true if AbstractCashPaymentMethodSpecificInput instances are equal
        /// </summary>
        /// <param name="other">Instance of AbstractCashPaymentMethodSpecificInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractCashPaymentMethodSpecificInput other)
        {
        ...
        public static bool operator ==(AbstractCashPaymentMethodSpecificInput left, AbstractCashPaymentMethodSpecificInput right)
        {

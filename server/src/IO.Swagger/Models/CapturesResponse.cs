...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CapturesResponse : Dictionary<String, Object>, IEquatable<CapturesResponse>
    { 
        /// <summary>
        /// The list of all captures performed on the requested payment.
        /// </summary>
        /// <value>The list of all captures performed on the requested payment.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapturesResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CapturesResponse)obj);
        }

        /// <summary>
        /// Returns true if CapturesResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CapturesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapturesResponse other)
        {
        ...
        public static bool operator ==(CapturesResponse left, CapturesResponse right)
        {

...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentCreationReferences : Dictionary<String, Object>, IEquatable<PaymentCreationReferences>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>The additional reference identifier for this transaction. Data in this property will also be returned in our report files, allowing you to reconcile them.</value>
        [DataMember(Name="additionalReference")]
        ...
        /// </summary>
        /// <value>The external reference identifier for this transaction. Data in this property will also be returned in our report files, allowing you to reconcile them.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentCreationReferences {\n");
            sb.Append("  AdditionalReference: ").Append(AdditionalReference).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PaymentCreationReferences)obj);
        }

        /// <summary>
        /// Returns true if PaymentCreationReferences instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentCreationReferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentCreationReferences other)
        {
            ...
            return 
                (
                    AdditionalReference == other.AdditionalReference ||
                    AdditionalReference != null &&
                    AdditionalReference.Equals(other.AdditionalReference)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AdditionalReference.GetHashCode();
        ...
        public static bool operator ==(PaymentCreationReferences left, PaymentCreationReferences right)
        {

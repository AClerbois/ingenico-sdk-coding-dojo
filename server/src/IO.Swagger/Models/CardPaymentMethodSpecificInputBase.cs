...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CardPaymentMethodSpecificInputBase : AbstractCardPaymentMethodSpecificInput, IEquatable<CardPaymentMethodSpecificInputBase>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CardPaymentMethodSpecificInputBase {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CardPaymentMethodSpecificInputBase)obj);
        }

        /// <summary>
        /// Returns true if CardPaymentMethodSpecificInputBase instances are equal
        /// </summary>
        /// <param name="other">Instance of CardPaymentMethodSpecificInputBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardPaymentMethodSpecificInputBase other)
        {
        ...
        public static bool operator ==(CardPaymentMethodSpecificInputBase left, CardPaymentMethodSpecificInputBase right)
        {

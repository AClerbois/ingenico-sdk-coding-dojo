...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CashPaymentMethodSpecificInputBase : AbstractCashPaymentMethodSpecificInput, IEquatable<CashPaymentMethodSpecificInputBase>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CashPaymentMethodSpecificInputBase {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CashPaymentMethodSpecificInputBase)obj);
        }

        /// <summary>
        /// Returns true if CashPaymentMethodSpecificInputBase instances are equal
        /// </summary>
        /// <param name="other">Instance of CashPaymentMethodSpecificInputBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CashPaymentMethodSpecificInputBase other)
        {
        ...
        public static bool operator ==(CashPaymentMethodSpecificInputBase left, CashPaymentMethodSpecificInputBase right)
        {

...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class EInvoicePaymentMethodSpecificInputBase : AbstractEInvoicePaymentMethodSpecificInput, IEquatable<EInvoicePaymentMethodSpecificInputBase>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EInvoicePaymentMethodSpecificInputBase {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EInvoicePaymentMethodSpecificInputBase)obj);
        }

        /// <summary>
        /// Returns true if EInvoicePaymentMethodSpecificInputBase instances are equal
        /// </summary>
        /// <param name="other">Instance of EInvoicePaymentMethodSpecificInputBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EInvoicePaymentMethodSpecificInputBase other)
        {
        ...
        public static bool operator ==(EInvoicePaymentMethodSpecificInputBase left, EInvoicePaymentMethodSpecificInputBase right)
        {

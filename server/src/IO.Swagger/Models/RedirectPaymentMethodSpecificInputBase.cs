...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RedirectPaymentMethodSpecificInputBase : AbstractRedirectPaymentMethodSpecificInput, IEquatable<RedirectPaymentMethodSpecificInputBase>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RedirectPaymentMethodSpecificInputBase {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RedirectPaymentMethodSpecificInputBase)obj);
        }

        /// <summary>
        /// Returns true if RedirectPaymentMethodSpecificInputBase instances are equal
        /// </summary>
        /// <param name="other">Instance of RedirectPaymentMethodSpecificInputBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RedirectPaymentMethodSpecificInputBase other)
        {
        ...
        public static bool operator ==(RedirectPaymentMethodSpecificInputBase left, RedirectPaymentMethodSpecificInputBase right)
        {

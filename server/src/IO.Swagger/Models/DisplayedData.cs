...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DisplayedData : Dictionary<String, Object>, IEquatable<DisplayedData>
    { 
        /// <summary>
        /// Gets or Sets DisplayedDataType
        /// </summary>
        [DataMember(Name="displayedDataType")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DisplayedData {\n");
            sb.Append("  DisplayedDataType: ").Append(DisplayedDataType).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DisplayedData)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (DisplayedDataType != null)
                    hashCode = hashCode * 59 + DisplayedDataType.GetHashCode();
        ...
        public static bool operator ==(DisplayedData left, DisplayedData right)
        {

...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RefundsResponse : Dictionary<String, Object>, IEquatable<RefundsResponse>
    { 
        /// <summary>
        /// The list of all refunds performed on the requested payment.
        /// </summary>
        /// <value>The list of all refunds performed on the requested payment.</value>
        [DataMember(Name="refunds")]
        public List<RefundResult> Refunds { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RefundsResponse)obj);
        }

        /// <summary>
        /// Returns true if RefundsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of RefundsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundsResponse other)
        {
        ...
        public static bool operator ==(RefundsResponse left, RefundsResponse right)
        {

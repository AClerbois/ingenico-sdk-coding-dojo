...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GetHostedCheckoutResponse : Dictionary<String, Object>, IEquatable<GetHostedCheckoutResponse>
    { 
        /// <summary>
        /// Gets or Sets CreatedPaymentOutput
        /// </summary>
        [DataMember(Name="createdPaymentOutput")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetHostedCheckoutResponse {\n");
            sb.Append("  CreatedPaymentOutput: ").Append(CreatedPaymentOutput).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GetHostedCheckoutResponse)obj);
        }

        /// <summary>
        /// Returns true if GetHostedCheckoutResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of GetHostedCheckoutResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetHostedCheckoutResponse other)
        {
            ...
            return 
                (
                    CreatedPaymentOutput == other.CreatedPaymentOutput ||
                    CreatedPaymentOutput != null &&
                    CreatedPaymentOutput.Equals(other.CreatedPaymentOutput)
                ) && 
                (
                    Status == other.Status ||
                    Status != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CreatedPaymentOutput.GetHashCode();
                    if (Status != null)
        ...
        public static bool operator ==(GetHostedCheckoutResponse left, GetHostedCheckoutResponse right)
        {

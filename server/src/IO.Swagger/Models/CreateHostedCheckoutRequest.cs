...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CreateHostedCheckoutRequest : Dictionary<String, Object>, IEquatable<CreateHostedCheckoutRequest>
    { 
        /// <summary>
        /// Gets or Sets CardPaymentMethodSpecificInput
        /// </summary>
        [DataMember(Name="cardPaymentMethodSpecificInput")]
        public CardPaymentMethodSpecificInputBase CardPaymentMethodSpecificInput { get; set; }

        /// <summary>
        /// Gets or Sets FraudFields
        /// </summary>
        [DataMember(Name="fraudFields")]
        public FraudFields FraudFields { get; set; }

        /// <summary>
        /// Gets or Sets HostedCheckoutSpecificInput
        /// </summary>
        [DataMember(Name="hostedCheckoutSpecificInput")]
        ...
        /// </summary>
        [DataMember(Name="redirectPaymentMethodSpecificInput")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateHostedCheckoutRequest {\n");
            sb.Append("  CardPaymentMethodSpecificInput: ").Append(CardPaymentMethodSpecificInput).Append("\n");
            sb.Append("  FraudFields: ").Append(FraudFields).Append("\n");
            sb.Append("  HostedCheckoutSpecificInput: ").Append(HostedCheckoutSpecificInput).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CreateHostedCheckoutRequest)obj);
        }

        /// <summary>
        /// Returns true if CreateHostedCheckoutRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateHostedCheckoutRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateHostedCheckoutRequest other)
        {
            ...
            return 
                ...
                (
                    HostedCheckoutSpecificInput == other.HostedCheckoutSpecificInput ||
                    HostedCheckoutSpecificInput != null &&
                    HostedCheckoutSpecificInput.Equals(other.HostedCheckoutSpecificInput)
                ) && 
                (
                    Order == other.Order ||
                    Order != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + HostedCheckoutSpecificInput.GetHashCode();
                    if (Order != null)
        ...
        public static bool operator ==(CreateHostedCheckoutRequest left, CreateHostedCheckoutRequest right)
        {

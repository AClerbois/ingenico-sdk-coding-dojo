...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BankTransferPaymentMethodSpecificInput : AbstractBankTransferPaymentMethodSpecificInput, IEquatable<BankTransferPaymentMethodSpecificInput>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankTransferPaymentMethodSpecificInput {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BankTransferPaymentMethodSpecificInput)obj);
        }

        /// <summary>
        /// Returns true if BankTransferPaymentMethodSpecificInput instances are equal
        /// </summary>
        /// <param name="other">Instance of BankTransferPaymentMethodSpecificInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankTransferPaymentMethodSpecificInput other)
        {
        ...
        public static bool operator ==(BankTransferPaymentMethodSpecificInput left, BankTransferPaymentMethodSpecificInput right)
        {

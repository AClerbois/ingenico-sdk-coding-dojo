...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RefundErrorResponse : Dictionary<String, Object>, IEquatable<RefundErrorResponse>
    { 
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets RefundResult
        /// </summary>
        [DataMember(Name="refundResult")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RefundResult: ").Append(RefundResult).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RefundErrorResponse)obj);
        }

        /// <summary>
        /// Returns true if RefundErrorResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of RefundErrorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundErrorResponse other)
        {
            ...
            return 
                ...
                (
                    RefundResult == other.RefundResult ||
                    RefundResult != null &&
                    RefundResult.Equals(other.RefundResult)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + RefundResult.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(RefundErrorResponse left, RefundErrorResponse right)
        {

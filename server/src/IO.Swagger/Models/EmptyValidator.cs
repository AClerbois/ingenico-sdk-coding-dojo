...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class EmptyValidator : Dictionary<String, Object>, IEquatable<EmptyValidator>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmptyValidator {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EmptyValidator)obj);
        }

        /// <summary>
        /// Returns true if EmptyValidator instances are equal
        /// </summary>
        /// <param name="other">Instance of EmptyValidator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmptyValidator other)
        {
        ...
        public static bool operator ==(EmptyValidator left, EmptyValidator right)
        {

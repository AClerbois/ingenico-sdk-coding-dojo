...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RefundMethodSpecificOutput : Dictionary<String, Object>, IEquatable<RefundMethodSpecificOutput>
    { 
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="totalAmountRefunded")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundMethodSpecificOutput {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RefundMethodSpecificOutput)obj);
        }

        /// <summary>
        /// Returns true if RefundMethodSpecificOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of RefundMethodSpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundMethodSpecificOutput other)
        {
            ...
            return 
                ...
                (
                    TotalAmountRefunded == other.TotalAmountRefunded ||
                    TotalAmountRefunded != null &&
                    TotalAmountRefunded.Equals(other.TotalAmountRefunded)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + TotalAmountRefunded.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(RefundMethodSpecificOutput left, RefundMethodSpecificOutput right)
        {

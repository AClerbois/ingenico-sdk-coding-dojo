...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class MandateNonSepaDirectDebit : IEquatable<MandateNonSepaDirectDebit>
    { 
        /// <summary>
        /// Gets or Sets PaymentProduct705SpecificData
        /// </summary>
        [DataMember(Name="paymentProduct705SpecificData")]
        public TokenNonSepaDirectDebitPaymentProduct705SpecificData PaymentProduct705SpecificData { get; set; }

        /// <summary>
        /// Gets or Sets PaymentProduct730SpecificData
        /// </summary>
        [DataMember(Name="paymentProduct730SpecificData")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MandateNonSepaDirectDebit {\n");
            sb.Append("  PaymentProduct705SpecificData: ").Append(PaymentProduct705SpecificData).Append("\n");
            sb.Append("  PaymentProduct730SpecificData: ").Append(PaymentProduct730SpecificData).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MandateNonSepaDirectDebit)obj);
        }
        ...
        public static bool operator ==(MandateNonSepaDirectDebit left, MandateNonSepaDirectDebit right)
        {

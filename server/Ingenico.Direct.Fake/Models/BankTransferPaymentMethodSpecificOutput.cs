...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BankTransferPaymentMethodSpecificOutput : AbstractPaymentMethodSpecificOutput, IEquatable<BankTransferPaymentMethodSpecificOutput>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankTransferPaymentMethodSpecificOutput {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BankTransferPaymentMethodSpecificOutput)obj);
        }

        /// <summary>
        /// Returns true if BankTransferPaymentMethodSpecificOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of BankTransferPaymentMethodSpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankTransferPaymentMethodSpecificOutput other)
        {
        ...
        public static bool operator ==(BankTransferPaymentMethodSpecificOutput left, BankTransferPaymentMethodSpecificOutput right)
        {

...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AbstractSepaDirectDebitPaymentMethodSpecificInput : AbstractPaymentMethodSpecificInput, IEquatable<AbstractSepaDirectDebitPaymentMethodSpecificInput>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AbstractSepaDirectDebitPaymentMethodSpecificInput {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AbstractSepaDirectDebitPaymentMethodSpecificInput)obj);
        }

        /// <summary>
        /// Returns true if AbstractSepaDirectDebitPaymentMethodSpecificInput instances are equal
        /// </summary>
        /// <param name="other">Instance of AbstractSepaDirectDebitPaymentMethodSpecificInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractSepaDirectDebitPaymentMethodSpecificInput other)
        {
        ...
        public static bool operator ==(AbstractSepaDirectDebitPaymentMethodSpecificInput left, AbstractSepaDirectDebitPaymentMethodSpecificInput right)
        {

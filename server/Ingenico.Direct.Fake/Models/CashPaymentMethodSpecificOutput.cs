...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CashPaymentMethodSpecificOutput : AbstractPaymentMethodSpecificOutput, IEquatable<CashPaymentMethodSpecificOutput>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CashPaymentMethodSpecificOutput {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CashPaymentMethodSpecificOutput)obj);
        }

        /// <summary>
        /// Returns true if CashPaymentMethodSpecificOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of CashPaymentMethodSpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CashPaymentMethodSpecificOutput other)
        {
        ...
        public static bool operator ==(CashPaymentMethodSpecificOutput left, CashPaymentMethodSpecificOutput right)
        {

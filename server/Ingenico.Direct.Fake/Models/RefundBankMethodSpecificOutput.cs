...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RefundBankMethodSpecificOutput : RefundMethodSpecificOutput, IEquatable<RefundBankMethodSpecificOutput>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundBankMethodSpecificOutput {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RefundBankMethodSpecificOutput)obj);
        }

        /// <summary>
        /// Returns true if RefundBankMethodSpecificOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of RefundBankMethodSpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundBankMethodSpecificOutput other)
        {
        ...
        public static bool operator ==(RefundBankMethodSpecificOutput left, RefundBankMethodSpecificOutput right)
        {

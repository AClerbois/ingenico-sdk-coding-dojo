...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Card : CardWithoutCvv, IEquatable<Card>
    { 
        /// <summary>
        /// Card Verification Value, a 3 or 4 digit code used as an additional security feature for card not present transactions.
        /// </summary>
        /// <value>Card Verification Value, a 3 or 4 digit code used as an additional security feature for card not present transactions.</value>
        [DataMember(Name="cvv")]

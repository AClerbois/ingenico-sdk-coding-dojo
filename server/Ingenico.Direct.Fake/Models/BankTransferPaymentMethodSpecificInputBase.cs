...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BankTransferPaymentMethodSpecificInputBase : AbstractBankTransferPaymentMethodSpecificInput, IEquatable<BankTransferPaymentMethodSpecificInputBase>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankTransferPaymentMethodSpecificInputBase {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BankTransferPaymentMethodSpecificInputBase)obj);
        }

        /// <summary>
        /// Returns true if BankTransferPaymentMethodSpecificInputBase instances are equal
        /// </summary>
        /// <param name="other">Instance of BankTransferPaymentMethodSpecificInputBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankTransferPaymentMethodSpecificInputBase other)
        {
        ...
        public static bool operator ==(BankTransferPaymentMethodSpecificInputBase left, BankTransferPaymentMethodSpecificInputBase right)
        {

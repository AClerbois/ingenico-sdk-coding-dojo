...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RefundCardMethodSpecificOutput : RefundMethodSpecificOutput, IEquatable<RefundCardMethodSpecificOutput>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundCardMethodSpecificOutput {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RefundCardMethodSpecificOutput)obj);
        }

        /// <summary>
        /// Returns true if RefundCardMethodSpecificOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of RefundCardMethodSpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundCardMethodSpecificOutput other)
        {
        ...
        public static bool operator ==(RefundCardMethodSpecificOutput left, RefundCardMethodSpecificOutput right)
        {
